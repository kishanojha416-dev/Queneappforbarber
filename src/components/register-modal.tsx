...
export function RegisterModal({ onClose, onRegister }: RegisterModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden my-8">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="bg-gradient-to-br from-violet-600 to-blue-600 p-8 text-center">
          ...
          <p className="text-violet-100">Join TrimTime and skip the wait!</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border ${errors.fullName ? 'border-rose-300' : 'border-slate-200'} rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition`}
              />
              {errors.fullName && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border ${errors.email ? 'border-rose-300' : 'border-slate-200'} rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition`}
              />
              {errors.email && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border ${errors.phone ? 'border-rose-300' : 'border-slate-200'} rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition`}
              />
              {errors.phone && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border ${errors.password ? 'border-rose-300' : 'border-slate-200'} rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition pr-12`}
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border ${errors.confirmPassword ? 'border-rose-300' : 'border-slate-200'} rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition pr-12`}
                />
                <button
                  type="button"
